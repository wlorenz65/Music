...
License is CC0. Runs on Termux on my Android tablet while VLC is playing in the background. Provides star ratings for each song with a single keypress [+] / [–]. In random mode, five-star songs get played 17× as often as two-star songs.
